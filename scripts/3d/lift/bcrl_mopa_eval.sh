...
step_switch_policy_only='600000'
expert_mode="mopa"
...
# for evaluation
date='None'
# log_dir='out/mopa_rl_asymmetric_sac_sawyer_lift_1234_best_checkpoint' # without pretrained critic
# ckpt_num='4890000' # without pretrained critic
log_dir='out/mopa-rl-asym-sac-pretrained-critic-1234-3dlift' # with pretrained critic
ckpt_num='1930000' # with pretrained critic
is_train='False'
wandb='False'
num_eval='100'
save_rollout='True'
