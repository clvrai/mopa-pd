...
# machine parameters
bc_checkpoint="out/bc_visual_policy_stochastic_sawyer_push_32px_1m_checkpoint_30out30_screenresfix/epoch_12.pth" # BC Visual Policy Stochastic checkpoint
mopa_checkpoint="out/mopa_rl_sawyer_push_1million_checkpoint/ckpt_01000000.pt"
