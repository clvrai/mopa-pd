...
max_global_step='1300000'
max_episode_steps='250'
max_episode_step='250'
step_switch_policy_only='1300000'
expert_mode="mopa-sota"
...
# for evaluation
date='None'
log_dir='logs/rl.SawyerPushObstacle-v0.06.11.15.12.MoPA-RL-RL-SAC-SOTA.0'
ckpt_num='1200000'
is_train='False'
wandb='False'
num_eval='100'
