...
# for evaluation
date='None'
# log_dir='out/mopa_rl_asymmetric_sac_sawyer_push_1234_best_checkpoint' # without pretrained critic
# ckpt_num='2900000' # without pretrained critic
log_dir='out/mopa-rl-asym-sac-pretrained-critic-1234-3dpush' # with pretrained critic
ckpt_num='930000' # with pretrained critic
is_train='False'
wandb='False'
num_eval='100'
save_rollout='True'
