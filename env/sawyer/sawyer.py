...
class SawyerEnv(BaseEnv):
    ...
    @property
    def is_jnt_limited(self):
        return self._is_jnt_limited
    
    @property
    def ac_scale(self):
        return self._ac_scale
    ...
    @property
    def jnt_minimum(self):
        return self._jnt_minimum

    @property
    def jnt_maximum(self):
        return self._jnt_maximum
    ...
    def _step(self, action, is_planner=False, is_mopa_rl=True):
        """
