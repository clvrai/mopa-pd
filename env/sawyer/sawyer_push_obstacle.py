...
class SawyerPushObstacleEnv(SawyerEnv):
    ...
    def _reset(self):
        # self._set_camera_position(2, [2.56, 0., 1.25]) # default camera position

        # Cam Position: Candidate 1
        ...
        # init_qpos = (
        #     self.init_qpos + self.np_random.randn(self.init_qpos.shape[0]) * 0.1 # makes this task harder
        # )
